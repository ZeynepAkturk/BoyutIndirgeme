function hata_degeri = problem(agirlik,egitim_veri,test_veri,komsu_sayisi)
...
for i=1:egitim_sayisi
    for j=1:test_sayisi
        for k=1:nitelik_sayisi
            uzaklik_dizisi(i,j)=uzaklik_dizisi(i,j)+(agirlik(k)*(egitim_veri(i,k)-test_veri(j,k))^2);
        end
